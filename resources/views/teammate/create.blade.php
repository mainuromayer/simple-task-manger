...
@section('content')
    <div class="container mt-5">
        ...
        <div class="row mt-2 mb-3">
            <form action="{{ route('teammate.store') }}" method="post" class="col-12">
                @csrf
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="text" name="position" id="position" class="form-control" value="{{ old('position') }}" placeholder="Enter position">
                    @error('position')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
